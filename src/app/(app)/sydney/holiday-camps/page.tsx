...
export async function generateMetadata() {
  const pageData = await reader.singletons.sydneyHolidayCamps.readOrThrow({
...
export default async function Example() {
  const data = await reader.singletons.sydneyHolidayCamps.readOrThrow({ resolveLinkedFiles: true })
  return (
    <>
