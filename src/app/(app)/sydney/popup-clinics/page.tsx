...
export async function generateMetadata() {
  const pageData = await reader.singletons.sydneyPopupClinics.readOrThrow({
...
export default async function Example() {
  const data = await reader.singletons.sydneyPopupClinics.readOrThrow({ resolveLinkedFiles: true })
  return (
    <>
