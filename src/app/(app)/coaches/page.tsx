...
export default async function Example() {
  const coachesPage = await reader.singletons.coachesPage.readOrThrow()
    ...
    <div className="bg-white py-24 md:py-32">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-5">
        <div className="max-w-2xl xl:col-span-2">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">{coachesPage.introText}</p>
        </div>
          ...
          {coaches.map((coach) => (
            <li key={coach.entry.name} className="flex flex-col gap-10 pt-12 sm:flex-row">
              ...
              <div className="max-w-xl flex-auto">
                ...
                <p className="mt-6 text-base leading-7 text-gray-600">{coach.entry.shortIntro}</p>
