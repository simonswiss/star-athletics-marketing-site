...
export async function generateMetadata() {
  const pageData = await reader.singletons.woopiTeamRelay.readOrThrow({
...
export default async function Example() {
  const data = await reader.singletons.woopiTeamRelay.readOrThrow({ resolveLinkedFiles: true })
  return (
    <>
