...
export async function generateMetadata() {
  const pageData = await reader.singletons.woopiPopupClinics.readOrThrow({
...
export default async function Example() {
  const data = await reader.singletons.woopiPopupClinics.readOrThrow({ resolveLinkedFiles: true })
  return (
    <>
