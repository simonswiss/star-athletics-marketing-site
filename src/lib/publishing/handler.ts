import { PUBLISHING_VERSION } from "./config";
...
export async function handlePublishing(
  ...
  try {
    ...
    if (!body || typeof body !== "object")
      throw new PublishingError("Invalid publishing request.", 400);
    if (body.version !== PUBLISHING_VERSION)
      throw new PublishingError(
        "Reload Keystatic to use your personal drafts. This older editor cannot publish shared changes.",
        409,
      );
