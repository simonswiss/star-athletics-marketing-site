            ...
            {navigation.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={clsx(
                    'border-b-2 border-transparent text-sm font-semibold leading-6 text-gray-900 hover:border-gray-900',
...
const solutions = [
  {
    name: 'Sydney',
    description: `Session in Sydney's Northern Beaches`,
    href: '/sydney/sessions',
    icon: ChartPieIcon,
  },
  {
    name: 'Woopi',
    description: 'Sessions in Woolgoolga',
    href: '/woopi/sessions',
