---
title: Woopi School Sessions
heroImage: /images/pages/woopi/schools/heroImage.jpeg
booking:
  discriminant: false
---
...
_Programs start from $4.50 per session, per student_
...
_Programs start from $5.50 per session, per student_
